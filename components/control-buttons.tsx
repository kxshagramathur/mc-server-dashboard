...
export function ControlButtons({
  ...
  return (
    <div className="bg-white/5 border border-white/10 hover:border-[#B89000] backdrop-blur-lg rounded-[2rem] p-8 flex flex-col items-center justify-center shadow-2xl col-span-1 md:col-span-2 lg:col-span-1 transition-all duration-300 hover:shadow-[0_0_20px_rgba(184,144,0,0.4)]">
      <h2 className="font-mono text-sm tracking-[0.2em] text-white/60 mb-6 uppercase">
        Controls
      </h2>
      <div className="flex flex-col gap-4 w-full">
        <Button
          className="w-full text-base tracking-wide flex items-center justify-center gap-3 uppercase transition-all"
